...
// player one 
let playerOneMoveOneType , playerOneMoveTwoType , playerOneMoveThreeType,playerOneMoveOneValue,playerOneMoveTwoValue,playerOneMoveThreeValue, playerOneWins

//player two

let playerTwoMoveOneType,playerTwoMoveTwoType,playerTwoMoveThreeType,playerTwoMoveOneValue,playerTwoMoveTwoValue,playerTwoMoveThreeValue, playerTwoWins

const setPlayerMoves = (player, moveOneType, moveOneValue, moveTwoType, moveTwoValue, moveThreeType, moveThreeValue) =>{ 
    //create a fail fast return if any values were not provided
...
//create a helper function "isValidMoveType" with a parameter "moveType" to validate value of "rock","paper"or"scissors"
...
function getGameWinner(){
    ...
    !playerOneMoveTwoValue|| !playerOneMoveThreeValue || !playerTwoMoveOneType||!playerTwoMoveTwoType || !playerTwoMoveThreeType ||
    !playerTwoMoveOneValue || !playerTwoMoveTwoValue || !playerTwoMoveThreeValue) {return null;}
        playerOneWins=0
        playerTwoWins=0
